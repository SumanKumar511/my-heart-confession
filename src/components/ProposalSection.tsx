      ...
      <div className="max-w-2xl mx-auto text-center relative z-10">
        ...
        >
          ...
          <p className="font-heading text-xl md:text-2xl text-primary italic mt-6">
            "Vo kaunsa special equation hai jisme tum + main = forever?" 😘💘
          </p>
        </motion.div>
...
>
  ...
  <span className="block mt-6 text-xl md:text-2xl">
    <span className="text-red-500 font-bold">
      Warning:
    </span>{" "}
    Warning: Agar haan bola… toh iss Valentine ka pura haq mera hoga 😉❤️
  </span>
</motion.h3>
            ...
            >
              ...
              <div className="bg-card/90 backdrop-blur rounded-2xl p-10 shadow-2xl border border-border">
                ...
                <p className="font-body text-lg text-muted-foreground">
                  ...
                  >
                    This day of yours is officially my now
                  </a> 
                  <br />Let’s make this day as special as you are to me. 🌹✨
                </p>
              </div>
            </motion.div>
          )}
